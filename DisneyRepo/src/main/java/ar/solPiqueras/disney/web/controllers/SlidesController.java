...
import ar.solPiqueras.disney.domain.slides.SimpleSlide;
import ar.solPiqueras.disney.domain.slides.Slides;
import ar.solPiqueras.disney.domain.slides.SlidesService;
import ar.solPiqueras.disney.domain.slides.response.SlideShortResponse;
import lombok.*;
...
public class SlidesController {
    ...
    public static class SlidesDto implements Serializable {
        ...
        @NotNull
        private OrganizationController.OrganizationDto organizationDto;
