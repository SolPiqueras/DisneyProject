...
import ar.solPiqueras.disney.domain.users.UserService;
...
import ar.solPiqueras.disney.web.security.jwt.JwtUtils;
import lombok.Data;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> register(@Valid @RequestBody UserDTO newUser, HttpServletResponse response, HttpServletRequest request) throws ServletException {
        ...
        String access_token = JwtUtils.generateAccessToken(springUser, request);
