...
import ar.solPiqueras.disney.data.repositories.ContactRepository;
...
class ContactControllerTest {
    ...
    private ContactController.ContactDTO buildContactDto(Long id, String name, String phone, String email, String message) {
        return ContactController.ContactDTO.builder()
                .id(id)
                .name(name)
                .email(email)
                .message(message)
