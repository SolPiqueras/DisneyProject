...
class MemberControllerTest {
    ...
    void save_success() throws Exception {
        MemberController.MemberDTO memberDTO = buildDto();
    ...
    void getMembersByPage_success() throws Exception {
        List<MemberController.MemberDTO> memberDTOS = new ArrayList<>();
    ...
    void update_success() throws Exception {
        MemberController.MemberDTO dtoBody = buildDto();
    ...
    void update_BadRequest() throws Exception {
        MemberController.MemberDTO dtoBody = MemberController.MemberDTO.builder()
                .name(null)
                .image(null)
                .build();
        MemberEntity resultEntity = buildEntity(5L);
    ...
    private MemberController.MemberDTO buildDto() {
        return MemberController.MemberDTO.builder()
                .name("TestName")
                .facebookUrl("https://www.facebook.com/profile")
                .instagramUrl("https://www.instagram.com/profile")
                .linkedinUrl("https://www.linkedin.com/profile")
