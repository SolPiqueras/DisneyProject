...
public class OrganizationControllerTest {
    ...
    void get_success() throws Exception{
        OrganizationController.OrganizationSimpleDto dtoSimple = buildSimpleDto();
    ...
    void update_success() throws Exception {
        OrganizationController.OrganizationDto dtoBody = buildDto(1L);
        OrganizationEntity resultEntity = buildEntity(1L);
    ...
    void update_NotFound() throws Exception {
        OrganizationController.OrganizationDto dtoBody = buildDto(2L);
    ...
    void update_BadRequest() throws Exception{
        OrganizationController.OrganizationDto dtoBody = OrganizationController.OrganizationDto.builder()
                .name(null)
                .image(null)
                .email(null)
                .welcome_text(null)
    ...
    private OrganizationController.OrganizationDto buildDto(long idOrganization) {
        OrganizationController.OrganizationDto ong = OrganizationController.OrganizationDto.builder()
                .name("Test O-N-G")
                .image("https://www.testong.com/image.png")
                .address("Test 123")
                .phone(1231231666)
    ...
    private OrganizationController.OrganizationSimpleDto buildSimpleDto(){
        OrganizationController.OrganizationSimpleDto simpleDto = OrganizationController.OrganizationSimpleDto.builder()
                .name("Test O-N-G")
                .image("https://www.testong.com/image.png")
                .address("Test 123")
                .phone(1231231666)
